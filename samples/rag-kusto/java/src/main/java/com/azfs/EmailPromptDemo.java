...
public class EmailPromptDemo {
    ...
    public HttpResponseMessage promptEmail(
        ...
        @SemanticSearch(name = "search", connectionName = "KustoConnectionString", collection = "Documents", query = "{Prompt}", chatModel = "%CHAT_MODEL_DEPLOYMENT_NAME%", embeddingsModel = "%EMBEDDING_MODEL_DEPLOYMENT_NAME%" ) SemanticSearchContext semanticSearchContext,
